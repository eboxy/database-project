...
public partial class UserControls_grd_Artistdata_Artist : System.Web.UI.UserControl
{
    ...
    protected void grd_Artistdata_Artist_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        //Leta upp kontroller:
        ...
        catch (FormatException err)
        {
            ...
            string mess = "<h2>[Uctrl]UCtrlgrdArtistdata_Artist.dbtn_Visa_Kortbio:FormatException</h2>";
        ...
        catch (MySqlException err)
        {
            ...
            string mess = "<h2>[Uctrl]UCtrlgrdArtistdata_Artist.dbtn_Visa_Kortbio:MySqlException</h2>";
            mess += "<h2>Felmeddelande: " + err.Message + "</h2>";
            display.InnerHtml = mess;
        }
        catch (System.Exception err)
        {
            ...
            string mess = "<h2>[Uctrl]UCtrlgrdArtistdata_Artist.dbtn_Visa_Kortbio:System.Exception</h2>";
            mess += "<h2>Felmeddelande: " + err.Message + "</h2>";
            display.InnerHtml = mess;
        }
    }

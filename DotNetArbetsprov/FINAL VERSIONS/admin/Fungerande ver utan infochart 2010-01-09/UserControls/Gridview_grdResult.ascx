...
<asp:GridView ID="grdResult" runat="server" BackColor="White" AllowPaging="true" PageSize="6" 
    ...
    <Columns>
      ...
      <asp:TemplateField HeaderText="Mark" ItemStyle-CssClass="grid_style" HeaderStyle-CssClass="pos_grdresult" >
          <HeaderTemplate>
                                        
              <TF:DerivCheckBox ID="chkCDval_ALL" runat="server" Checked='<%# Bind("Val")%>' AutoPostBack="true"
                UnText='<%#Eval("#") %>' OnCheckedChanged="chkCDvalALLGrdRes_CheckedChanged" />
                                               
           </HeaderTemplate>
                                        
           <ItemTemplate>
     
             <TF:DerivCheckBox ID="chkCDval" runat="server" Checked='<%# Bind("Val")%>' AutoPostBack="true"
              UnText='<%#Eval("#") %>' OnCheckedChanged="chkCDval_CheckedChanged" />

<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Panel_Kommentar_Inkop.ascx.cs" Inherits="UserControls_Panel_Kommentar_Inkop" %>

  
  <!-- Administrering av längre kommentarer: -->

  <asp:Panel ID="pnlKommentar_Inkop" runat="server" Visible="false">

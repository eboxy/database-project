...
<head runat="server">
    <title>DotNetTest_Component</title>
...
<body onload="datum(); setInterval('datum()', 1000 )">
        ...
        <div id="content">
              ...
              <div class="ruta">
                ...
                <asp:Panel ID="frame" runat="server">
                         ...
                         <TF:UGridResult ID="grdResult_UCtrl"  Visible="true" runat="server" />
                         
                        <!-- GridView för att visa resultat från Hämta-funktion och sökning (i usercontrol): -->
                         <TF:UGridArtistdata ID="grd_Artistdata_UCtrl" Visible="true" runat="server" />
                         
                        <!-- GridView som visar hel tabell inkl paging etc: -->
                        <TF:UGridArtister ID="gridArtister_Uctrl" Visible="true" runat="server" />
                        
                        <!-- Panel för administrering av omfattande kommentarer:  -->
                        <TF:UPnlKommentar ID="pnlKommentar_UCtrl" Visible="true" runat="server" />
                      
                   
                      <!-- För att visa information/data som skall stå under kontroll: -->
                      <span id="display2" runat="server" class="mess"></span>  
                
                     <!-- (3D-Pie)Chart som visar ytterligare information på info-sidan: -->
                   <asp:Chart ID="ch3DPie" runat="server" ImageStorageMode="UseImageLocation"
                     Width="350" Height="230" BackColor="#D8D8D8" Visible="false"
                       OnLoad="CreateChart" CssClass="ch3DPie" ImageType="Png" 
                        ImageLocation="~/ChartImage/chImg.png">
                        <Series>
                            <asp:Series Name="Series1">
                              </asp:Series>
                            </Series>
                          <Legends>
                           <asp:Legend Name="Musiktyp" BackColor="#D8D8D8">
                             </asp:Legend>
                            </Legends>
                        <ChartAreas>
                            <asp:ChartArea Name="ChartArea1" BackColor="#D8D8D8">
                               <AxisY>
                                </AxisY> 
                            </asp:ChartArea>
                        </ChartAreas>
                    ...
                    <asp:Label ID="lbl3DPie"  CssClass="lbl3DPie" runat="server" 
                    Text="Antal artister per musiktyp" EnableTheming="false" Visible="false">
                    </asp:Label> 
    ...
    <div id="navigation">
             ...
             <!--Textrutor RAD1: -->
              ...
              <asp:ListItem Value="Rea" />
               ...
               <asp:Button ID="button_visa_databas" runat="server" 
                ...
                CssClass="input move rad2" Text="Info" 
           ...
           AutoPostBack="true" CssClass="optSkivtabell" Checked="true"

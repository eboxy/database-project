              ...
              <div class="ruta">
                ...
                <asp:Panel ID="frame" runat="server">
                      ...
                      <span id="display" runat="server" class="mess"></span>
                        ...
                        <!-- Panel för in- och utmaning av artists korbio i artst-tabell:  -->
                        <TF:UPnlKortbio ID="pnlKortbio_UCtrl" Visible="true" runat="server" />   
             ...
             <!--Textrutor RAD1: -->
              ...
              <asp:ListItem Value="Rea" />
               ...
               <asp:Button ID="button_visa_databas" runat="server" 
                ...
                CssClass="input move rad2" Text="Kortbio" 
                   onclick="button_kortbiopanel_Click"  
                   CausesValidation="False"/>
                ...
                CssClass="input move rad2" Text="HOLDER" 
                   CausesValidation="False"/>       

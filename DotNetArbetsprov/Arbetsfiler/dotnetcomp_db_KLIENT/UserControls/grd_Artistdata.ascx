<%@ Control Language="C#" AutoEventWireup="true" CodeFile="grd_Artistdata.ascx.cs" Inherits="UserControls_grd_Artistdata" %>
 ...
 <!-- GridView som visar data om en artist: -->
  ...
  <asp:GridView ID="grd_Artistdata" runat="server"  AllowPaging="false"
    OnRowCommand="grd_Artistdata_RowCommand" HeaderStyle-CssClass="header">
